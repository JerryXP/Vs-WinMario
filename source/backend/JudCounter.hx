...
class JudCounter extends FlxTypedGroup<FlxText>
{
    ...
    static final MARVELOUSS_COLOR:FlxColor = 0xFFFF00FF;
    static final SICKS_COLOR:FlxColor = FlxColor.CYAN;
    static final GOODS_COLOR:FlxColor = 0xFF00C000;
    static final BADS_COLOR:FlxColor = FlxColor.YELLOW;
    static final SHITS_COLOR:FlxColor = FlxColor.RED;
    static final MISSES_COLOR:FlxColor = FlxColor.PURPLE;
    static final COMBO_COLOR:FlxColor = FlxColor.WHITE;
    static final MAX_COMBO_COLOR:FlxColor = FlxColor.WHITE;
    ...
    function cacheLabels():Void {
        var keys = [
            'judgement_marvelouss', 'judgement_sicks', 'judgement_goods', 'judgement_bads',
            'judgement_shits', 'judgement_misses', 'judgement_combo', 'judgement_max_combo'
        ];
        var defaults = [
            'Crazy', 'Cool', 'Good', 'Okay', 'Awful', 'Nope', 'Combo', 'Max Combo'
        ];
    ...
    {
        marveloussText = createJudgmentText(cachedLabels[0] + ':  0', MARVELOUSS_COLOR, 0);
    ...
    function updateSingleText(index:Int, value:Int):Void {
        switch (index) {
            case 0: marveloussText.text = cachedLabels[0] + ': $value';
    ...
    public function doBump(judgmentIndex:Int)
    {
        ...
        switch(judgmentIndex) {
            case 0: targetText = marveloussText;
