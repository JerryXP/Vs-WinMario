...
class Achievements {
	public static function init()
	{
		...
		createAchievement('win-week1',					{name: "What Happened?", description: "Beat Week 1"});
		createAchievement('win-week1_nomiss',					{name: "What Happened? No Miss? Awesome!", description: "Beat Week 1 on Hard or Insane\n without misses"});
		...
		createAchievement('win-week6',					{name: "Hero or Villain?", description: "Beat Week 6"});
		...
		createAchievement('special_1',				{name: "Happy New Year!!", description: "Beat Week 9"});
		createAchievement('special_1_nomiss',				{name: "What a Great Year to start!", description: "Beat Week 9 on Hard or Insane\n without misses"});
		createAchievement('special_2',				{name: "It's good to see you man!", description: "Beat Week 10"});
		createAchievement('special_2_nomiss',				{name: "It's good to see you without misses man!", description: "Beat Week 10 on Hard or Insane\n without misses"});
		createAchievement('special_3',				{name: "Hey Bestie!!!", description: "Beat Week 11"});
		createAchievement('special_3_nomiss',				{name: "SLAYED!!!", description: "Beat Week 11 on Hard or Insane\n without misses"});
		createAchievement('special_4',				{name: "Thank you so much for playing my game!", description: "Beat Week 12"});
		createAchievement('special_4_nomiss',				{name: "Yahoo!!", description: "Beat Week 12 on Hard or Insane\n without misses"});
		createAchievement('special_5',				{name: "ALL CORRUPTED OF US HAVE COLLAPSE", description: "Beat Week 13"});
		createAchievement('special_5_nomiss',				{name: "WE'VE BEEN DESTROYED WITH NO MISSES", description: "Beat Week 13 on Hard or Insane\n without misses"});
		createAchievement('special_6',				{name: "Thanks for a Visit!", description: "Beat Week 14"});
		createAchievement('special_6_nomiss',				{name: "No Misses again? Great!", description: "Beat Week 14 on Hard or Insane\n without misses"});
		createAchievement('special_7',				{name: "F*CKING HELL", description: "Beat Week 15"});
		createAchievement('special_7_nomiss',				{name: "GODDAMN YOU TO HELL!", description: "Beat Week 15 without misses"});
		createAchievement('special_8',				{name: "Thank you very much for playing my game!", description: "Beat Week 16"});
		createAchievement('special_8_nomiss',				{name: "You're a cool guy.", description: "Beat Week 16 without misses"});
