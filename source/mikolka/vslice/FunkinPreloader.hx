...
class FunkinPreloader extends FlxBasePreloader
{
	...
	public function new()
	{
		...
		trace("Welcome to Lunar Engine!!");
		trace('Initializing custom preloader...');

		this.siteLockTitleText = "PIRATE!! >:(";
	...
	override function create():Void
	{
		...
		progressLines.graphics.lineStyle(2, 0xFFFF11FF);
		...
		progressBarPiece.graphics.beginFill(0xFFFF11FF);
		...
		for (i in 0...amountOfPieces)
		{
			...
			piece.graphics.beginFill(0xFFFF11FF);
		...
		var progressLeftTextFormat = new TextFormat("Neon Zone Italic", 32, 0xFFFF11FF, true);
		...
		var progressRightTextFormat = new TextFormat("Neon Zone Italic", 16, 0xFFFF11FF, true);
		...
		enhancedText.textColor = 0xFFFF11FF;
		...
		stereoText.textColor = 0xFFFF11FF;
	...
	function updateProgressLeftText(text:Null<String>):Void
	{
		if (progressLeftText != null)
		{
			...
			else if (progressLeftText.text != text)
			{
				...
				enhancedText.defaultTextFormat = new TextFormat("Inconsolata Black", 16, 0xFFFF11FF, false);
				enhancedText.text = 'ENHANCED';
				enhancedText.textColor = 0xFFFF11FF;

				stereoText.defaultTextFormat = new TextFormat("neon-like", 36, 0xFFFF11FF, false);
				stereoText.text = 'LUNAR ENGINE (P-SLICE 1.0 FORK)';
			}
		}
	}
