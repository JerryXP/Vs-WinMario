...
class IntroSubstate extends MusicBeatSubstate
{
	...
	override function beatHit()
	{
		...
		switch (sickBeats)
		{
			...
			case 2:
					createCoolText(['Lunar Engine by'], 40);
				case 3:
					addMoreText('WinMario', 40);
				case 4:
					addMoreText('or LuigiXP', 40);
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Purple'], 40);
				case 7:
					addMoreText('Moon', 40);
				case 8:
					deleteCoolText();
				case 9:
					createCoolText(['Just like'], 40);
				case 10:
					addMoreText('Vs. WinMario', 40);
				case 11:
					deleteCoolText();
				case 12:
					createCoolText(['Codename:'], 40);
				case 13:
					addMoreText('Purple Forever', 40);
				case 14:
					deleteCoolText();
				case 15:
					createCoolText(['I am Not associated', 'with'], -40);
				case 16:
				...
				case 23:
					addMoreText('Funkin');
				case 24:
					addMoreText('Lunar Engine'); // credTextShit.text += '\nFunkin';
