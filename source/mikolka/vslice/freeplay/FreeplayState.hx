...
class FreeplayState extends MusicBeatSubstate
{
	...
	var diffIdsTotal:Array<String> = ['easy', "normal", "hard", "insane", "finale"]; // ? forcing this diff order
	...
	override function create():Void
	{
		...
		super.create();
		var diffIdsTotalModBinds:Map<String, String> = ["easy" => "", "normal" => "", "hard" => "", "insane" => "", "finale" => "",];
		...
		topLeftCornerText.font = 'vcr.ttf';
		...
		ostName.font = 'vcr.ttf';
		ostName.alignment = RIGHT;
		ostName.visible = false;

		charSelectHint.alignment = CENTER;
		charSelectHint.font = "Mario64.ttf";
	...
	function rankAnimStart(fromResults:FromResultsParams):Void
	{
		...
		if (fromResults.oldRank != null)
		{
			...
			{
				case SHIT:
					sparksADD.color = 0xFFFF4444;
				case GOOD:
					sparksADD.color = 0xFFFFEC44;
				case GREAT:
					sparksADD.color = 0xFF4DFF44;
				case EXCELLENT:
					sparksADD.color = 0xFF4450FF;
				case PERFECT:
					sparksADD.color = 0xFFF644FF;
				case PERFECT_GOLD:
					sparksADD.color = 0xFFFFC000;
			}
	...
	{ // H1
		...
		{
			var newColor:FlxColor = (curSelected == 0) ? 0xFF200080: daSongCapsule.songData.color;
