 ...
 * #end
 * 
 * For the last time... Don't you FUCKING TRY IT. Vs. WinMario or Engine is NOT FOR Psych 0.6.3.
 * 
 * Oh yeah, one more thing. "sngFC" is now not working anymore.
 * So... no wonder why it cost some ""Inaccuracy""..
 * but just like what I said to V-Slice Results Screen.
 * Please Don't Delete it or mess around with it.
*/
...
class Scoring
{
	...
	public static function calculateRankFromData(sngScore:Int, sngAccuracy:Float, sngFC:Bool):Null<ScoringRank>{
		...
		if (isPerfectGold) //Shiny Purple Star / Crazy / Truly Crazy
		{
		...
		if (sngAccuracy >= 0.90) //Magenta Star / Crazy
		{
			return ScoringRank.PERFECT;
		}
		else if (sngAccuracy >= 0.80) //Cyan Star / Cool / Sick
		{
			return ScoringRank.EXCELLENT;
		}
		else if (sngAccuracy >= 0.70) //Green Star / Good
		{
			return ScoringRank.GREAT;
		}
		else if (sngAccuracy >= 0.60) //Yellow Star / Ok / Bad
		{
			return ScoringRank.GOOD;
		}
		else //Red Star / Awful / Shit (This will also be here if Botplay or possibly Practice Mode was used.)
		{
