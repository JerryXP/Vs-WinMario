...
class CreditsChoice extends MusicBeatState
{
	...
	function openSelectedSubstate(label:String) {
		...
		{
			case 'Vs. WinMario':
				MusicBeatState.switchState(new states.creditsSource.WinMarioCreditsState());
			case 'P-Slice':
				MusicBeatState.switchState(new states.creditsSource.PSliceCredits());
			case 'Psych':
				MusicBeatState.switchState(new states.creditsSource.PsychCredits());
			case 'V-Slice':
				MusicBeatState.switchState(new states.creditsSource.FNFCredits());
			case 'MIDIs & FLPs':
				MusicBeatState.switchState(new states.creditsSource.MIDISnFLPS());
			#if MODS_ALLOWED
			case 'Mods':
				MusicBeatState.switchState(new states.creditsSource.ModCredits());
			#end
		}
	}
