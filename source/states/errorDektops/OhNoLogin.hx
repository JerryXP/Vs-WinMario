...
class OhNoLogin extends FlxState {
    ...
    override public function create():Void {
        ...
        message.loadGraphic("assets/shared/images/desktop/pop-up/jerry32-deleted (login).png"); // Use AssetPaths or a raw string "assets/images/player.png"
