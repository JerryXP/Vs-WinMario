   ...
   --easy script configs
    ...
    IntroTagColor = '00ff00' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Reactor', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Rareblin & EthanTheDoodler', 300, -305-IntroTagWidth, 260)
