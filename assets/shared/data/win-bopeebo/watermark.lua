   --Ps I use Bopeebop for exemples.
   
   --easy script configs
    IntroTextSize = 25	--Size of the text for the Now Playing thing.
    IntroSubTextSize = 28 --size of the text for the Song Name.
    IntroSubText2Size = 20 --size of the text for the Artist Name.
    IntroTagColor = 'ff00ff' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Win-Bopeebo (NEO)', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'JellyFish!', 300, -305-IntroTagWidth, 260)
