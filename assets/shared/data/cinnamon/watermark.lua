   ...
   --easy script configs
    ...
    IntroTagColor = 'ff8000' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Cinnamon', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Savestate Corrupted', 300, -305-IntroTagWidth, 260)
