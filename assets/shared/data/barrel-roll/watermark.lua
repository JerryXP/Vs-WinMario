   ...
   --easy script configs
    ...
    IntroTagColor = '0000ff' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Barrel Roll', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'Digital Hourglass', 300, -305-IntroTagWidth, 260)
