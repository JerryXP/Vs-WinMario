   ...
   --easy script configs
    ...
    IntroTagColor = '800000' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Sabotage', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'EthanTheDoodler', 300, -305-IntroTagWidth, 260)
