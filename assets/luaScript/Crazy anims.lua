...
function goodNoteHit(id, direction, noteType, isSustainNote)
    ...
    if swagPlayAnimation then
        ...
        if rating == 'marvelous' and direction == 0 then
            characterPlayAnim('boyfriend','singLEFT-alt','true')
        elseif rating == 'marvelous' and direction == 1 then
            characterPlayAnim('boyfriend','singDOWN-alt','true')
        elseif rating == 'marvelous' and direction == 2 then
            characterPlayAnim('boyfriend','singUP-alt','true')
        elseif rating == 'marvelous' and direction == 3 then
