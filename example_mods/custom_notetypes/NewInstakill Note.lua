function onCreate()
	...
	for i = 0, getProperty('unspawnNotes.length')-1 do
		...
		if getPropertyFromGroup('unspawnNotes', i, 'noteType') == 'NewInstakill Note' then
			setPropertyFromGroup('unspawnNotes', i, 'noteSplashData.texture', 'nnoteSplashes/noteSplashes-electric'); --Change texture
...
function goodNoteHit(id, noteData, noteType, isSustainNote)
	if noteType == 'NewInstakill Note' then
